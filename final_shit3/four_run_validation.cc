...
//   4) your fixed hybrid LHAPDF bias sample using the best parameters found so far
//
// Output:
//   <prefix>_naive.csv
//   <prefix>_ptcut50.csv
...
//
// Run example:
//   ./four_run_validation 100000 validation 12345 NNPDF31_lo_as_0118.tar.gz
//
// Optional arguments:
...
static Summary runSample(const RunConfig& cfg,
    ...
    for (int iEvent = 0; iEvent < nEvents; ++iEvent) {
        ...
        // For the custom hybrid bias, keep the same manual-unbiasing convention as in
        // your adaptive-search code.
