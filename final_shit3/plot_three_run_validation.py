#!/usr/bin/env python3
"""
Plot comparison results from three_run_validation.cc.

Usage:
    python plot_three_run_validation.py validation plots_validation
...
weights with:
    python plot_three_run_validation.py validation plots_pythia_weight --weight-col pythiaWeight
"""
...
def plot_summary_table(summary, outdir):
    ...
    table.scale(1, 1.4)
    plt.title("Three-run validation summary")
    savefig(outdir, "08_summary_table.png")


def main():
    parser = argparse.ArgumentParser()
    parser.add_argument("prefix", help="Output prefix used by three_run_validation.cc, e.g. validation")
    parser.add_argument("outdir", nargs="?", default="validation_plots")
